...
<div class="container contFont">
	...
	<div class="page-display " style="text-align:center;">
		...
		<c:forEach var="i" begin="${startPageNum}" end="${endPageNum }" >
			<c:choose>
				<c:when test="${pageNum eq i }">
					<li class="active">
						<a href="faqlistview.do?pageNum=${i }&condition=${condition}&keyword=${encodedKeyword}">${i }</a>
					</li>
				</c:when>
				<c:otherwise>
					<li>
		...
		<c:choose>
			<c:when test="${endPageNum lt totalPageCount }">
				<li>
					<a href="faqlistview.do?pageNum=${endPageNum+1 }&condition=${condition}&keyword=${encodedKeyword}">&raquo;</a>
				</li>
			</c:when>
			<c:otherwise>
				<li class="disabled">
	...
	<form action="faqlistview.do" method="get">
