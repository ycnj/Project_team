        ...
        <section id="home">     
            <div id="home-carousel" class="carousel slide" data-interval="false">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="item active"  style="background-image: url('${pageContext.request.contextPath}/resources/img/slider/베놈2.jpg')" >
                    ...
                    <div class="item" style="background-image: url('${pageContext.request.contextPath}/resources/img/slider/보헤미안 랩소디.jpg')">                
                        <div class="carousel-caption">
                    ...
                    <div class="item" style="background-image: url('${pageContext.request.contextPath}/resources/img/slider/스타이즈본.jpg')">                 
                         <div class="carousel-caption">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="about-us text-center wow fadeInDown">
                        <img src="${pageContext.request.contextPath}/resources/img/movie1.png" alt="About Us" class="img-responsive">
                    </div>
                </div>
            </div>
        </section>
