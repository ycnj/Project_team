...
<head>
<meta charset="UTF-8">
<title>/views/user/detail.jsp</title>
...
<script>
	...
	$(".comments form").on("submit", function(){
		...
		if(isLogin==false){
			...
			location.href="${pageContext.request.contextPath}/users/loginform.do?url=${pageContext.request.contextPath}/user/detail.do?num=${dto.num}";
